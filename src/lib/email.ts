...
export const SMTP_FROM = cleanEnvVar(process.env.SMTP_FROM) || (SMTP_USER ? `"InFixe Blog" <${SMTP_USER}>` : '"InFixe Blog" <newsletter@infixe.com>');
