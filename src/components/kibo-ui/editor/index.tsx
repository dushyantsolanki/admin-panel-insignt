...
export const EditorProvider = ({
  ...
  const defaultExtensions = [
    StarterKit.configure({
      codeBlock: false,
      heading: false, // Disable default heading to use the one with ID support
      bulletList: {
        HTMLAttributes: {
...
export const EditorTableGlobalMenu = ({
  ...
  return (
    <div
      className={cn(
        "-translate-x-1/2 fixed flex translate-y-1/2 items-center rounded-full border bg-background shadow-xl",
        {
          hidden: !(left || top),
        }
      )}
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger
        asChild
        className={cn(
          "-translate-x-1/2 -translate-y-1/2 fixed flex h-4 w-7 overflow-hidden rounded-md border bg-background shadow-xl",
          {
            hidden: !(left || top),
          }
        )}
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          className={cn(
            "-translate-x-1/2 -translate-y-1/2 fixed flex h-7 w-4 overflow-hidden rounded-md border bg-background shadow-xl",
            {
              hidden: !(left || top),
            }
          )}
          ...
          variant="ghost"
        >
          <EllipsisVertical className="text-muted-foreground" size={12} />
        </Button>
      </DropdownMenuTrigger>
      <DropdownMenuContent>{children}</DropdownMenuContent>
    </DropdownMenu>
...
export const EditorTableRowBefore = () => {
  ...
  return (
    <DropdownMenuItem className="flex items-center gap-2" onClick={handleClick}>
      <ArrowUp className="text-muted-foreground" size={16} />
    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <Button
          ...
          variant="ghost"
        >
          <Columns2 className="text-muted-foreground" size={16} />
        </Button>
      </TooltipTrigger>
      <TooltipContent>
    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <Button
          ...
          variant="ghost"
        >
          <Rows2 className="text-muted-foreground" size={16} />
        </Button>
      </TooltipTrigger>
      <TooltipContent>
    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <Button
          ...
          variant="ghost"
        >
          <TableCellsMerge className="text-muted-foreground" size={16} />
        </Button>
      </TooltipTrigger>
      <TooltipContent>
    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <Button
          ...
          variant="ghost"
        >
          <TableColumnsSplit className="text-muted-foreground" size={16} />
        </Button>
      </TooltipTrigger>
      <TooltipContent>
    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <Button
          ...
          variant="ghost"
        >
          <Bolt className="text-muted-foreground" size={16} />
        </Button>
      </TooltipTrigger>
      <TooltipContent>
        <span>Fix table</span>
